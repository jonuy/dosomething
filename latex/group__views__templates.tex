...
For each \hyperlink{classview}{view}, there will be a minimum of two templates used. The first is used for all views: \hyperlink{views-view_8tpl_8php}{views-\/view.tpl.php}.
