...
This function is a copy of menu\_\-link\_\-load() but with its own cache and a simpler query to load the link. This also skips normal menu link access checking by using \_\-token\_\-menu\_\-link\_\-translate().
